...
# from modeling.kmeans import mykmeans_plus

def learn_vocabulary(input_path, k, max_iter):
    # input_path = output/00005/temp_sift/1_sift.txt
...
def vlad_vector_batch(input_path, output_path, vocabulary):
    # input_path = output/00005/temp_sift/
    vladL = []
    file_names = list_all_files(input_path)
    for f in file_names:
        vladL.append(vlad_vector(vector_path=input_path + f, vocabulary=vocabulary))
